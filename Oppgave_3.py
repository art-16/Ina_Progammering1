...
#Basert på de to tallene, skrivv ut resultatet av samtlige av de følgende operatorene (Det holder med å skrive ut alle operasjonene etter hverandre, men det er jo alltids lov å gjøre det mer komplisert hvis man vil):
